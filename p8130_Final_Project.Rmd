...
```{r}
fit1 = lm(sal9495 ~ gender + dept + clin, data = lawsuit)
summary(fit1)

fit2 = lm(sal9495 ~ gender + dept + cert, data = lawsuit)
summary(fit2)

fit3 = lm(sal9495 ~ gender + dept + prate, data = lawsuit)
summary(fit3)

fit4 = lm(sal9495 ~ gender + dept + exper, data = lawsuit)
summary(fit4)

fit5 = lm(sal9495 ~ gender + dept + rank, data = lawsuit)
summary(fit5)
```


```{r}
reg3 = lm(sal9495 ~ gender + dept + clin + cert  + exper, data = lawsuit)
summary(reg3)
...
Add interaction
```{r}
fit1 = lm(sal9495 ~ gender * exper + dept + clin + cert, data = lawsuit)
summary(fit1)
```

```{r}
fit2 = lm(sal9495 ~ gender * dept +  exper  + clin + cert, data = lawsuit)
summary(fit2)
```
...
```{r}
fit3 = lm(sal9495 ~ gender * clin +  exper + cert + dept, data = lawsuit)
summary(fit3)
```

```{r}
fit4 = lm(sal9495 ~ gender * cert +  exper + clin + dept, data = lawsuit)
summary(fit4)
```


Interaction: gender * exper significant.
